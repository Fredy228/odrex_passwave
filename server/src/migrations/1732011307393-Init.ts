...
export class Init1732011307393 implements MigrationInterface {
    name = 'Init1732011307393'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`group_user\` (\`user\` int NOT NULL, \`group\` int NOT NULL, \`userId\` int NULL, \`groupId\` int NULL, PRIMARY KEY (\`user\`, \`group\`)) ENGINE=InnoDB`);
