...
export class Init1730203900298 implements MigrationInterface {
    name = 'Init1730203900298'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`password\` ADD \`entry\` varchar(250) NULL`);
        await queryRunner.query(`ALTER TABLE \`password\` ADD \`address\` varchar(500) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`password\` DROP COLUMN \`password\``);
        await queryRunner.query(`ALTER TABLE \`password\` ADD \`password\` text NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`privilege_group\` CHANGE \`userId\` \`userId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`privilege\` ADD CONSTRAINT \`FK_52e5cb580857920bc7728f29b1f\` FOREIGN KEY (\`companyId\`) REFERENCES \`company\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`privilege\` ADD CONSTRAINT \`FK_99db18aa80c6b26594787ddc72e\` FOREIGN KEY (\`groupId\`) REFERENCES \`privilege_group\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`privilege_group\` CHANGE \`userId\` \`userId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`privilege_group\` ADD CONSTRAINT \`FK_45d913b46966bb1f66d47ee85f5\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`password\` DROP COLUMN \`password\``);
        await queryRunner.query(`ALTER TABLE \`password\` ADD \`password\` varchar(500) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`password\` DROP COLUMN \`address\``);
        await queryRunner.query(`ALTER TABLE \`password\` DROP COLUMN \`entry\``);
    }
