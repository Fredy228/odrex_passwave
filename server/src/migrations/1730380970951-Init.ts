...
export class Init1730380970951 implements MigrationInterface {
    name = 'Init1730380970951'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`device\` DROP COLUMN \`edges_to\``);
        await queryRunner.query(`ALTER TABLE \`device\` ADD \`edges_to\` text NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`password\` DROP COLUMN \`files\``);
        await queryRunner.query(`ALTER TABLE \`password\` ADD \`files\` longtext NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`password\` DROP COLUMN \`files\``);
        await queryRunner.query(`ALTER TABLE \`password\` ADD \`files\` varchar(255) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`device\` DROP COLUMN \`edges_to\``);
        await queryRunner.query(`ALTER TABLE \`device\` ADD \`edges_to\` varchar(255) NOT NULL`);
