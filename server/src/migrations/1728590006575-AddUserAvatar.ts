...
export class AddUserAvatar1728590006575 implements MigrationInterface {
    name = 'AddUserAvatar1728590006575'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`avatar_url\` \`avatar_url\` varchar(500) NOT NULL`);
